...
export function ChallengeCard({ challenge, onSolve, isSolved = false, userId = null }) {
  ...
  // Add error handling for missing challenge
  if (!challenge) {
    return (
      <div className="text-center py-12">
        <BookOpen className="h-16 w-16 text-gray-400 mx-auto mb-4" />
        <h3 className="text-xl font-semibold text-gray-600 mb-2">No Challenge Available</h3>
      ...
      <div className="p-4 border-b border-gray-100 bg-gray-50">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-1 text-gray-600">
            ...
            <span className="text-sm font-medium">{challenge.current_score || 0}</span>
          </div>
        </div>
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-3 gap-3 mb-3">
          <div className="text-center">
            ...
            <p className="text-sm font-semibold text-gray-900">{challenge.solves || 0}</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm font-semibold text-gray-900">{challenge.initial_score || 0}</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm font-semibold text-gray-900">{challenge.current_score || 0}</p>
          </div>
        </div>
